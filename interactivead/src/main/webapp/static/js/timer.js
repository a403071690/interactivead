var str = "";   
document.writeln("<div id=\"_contents\" style=\"padding:5px;background-color:#ECF7FE;font-size:12px;border:1px solid #CFD1D5;position:absolute;left:0px; top:0px; z-index:4;visibility:hidden\">");
...
function _SetTime(tt) {   
	...
	document.all._contents.style.top = ttop + thei +3+"px";
