...
var Config = {
    homeIndexTemplatesName: [
        "carSellCampaign-carSellCampaign",
        "carSellCampaign-carSellCampaignPage",
        "carStore-carStore",
        "carStore-carStorePage",
        "publicCarInfo-publicCarInfo",
        "publicCarInfo-publicCarInfoPage",
        "relUserRole-relUserRole",
        "relUserRole-relUserRolePage",
        "sysUserSearchLog-sysUserSearchLog",
        "sysUserSearchLog-sysUserSearchLogPage",
        "userCarOrder-userCarOrder",
        "userCarOrder-userCarOrderPage",
        "userCarStoreOrder-userCarStoreOrder",
        "userCarStoreOrder-userCarStoreOrderPage",
        "userCompanyAuth-userCompanyAuth",
        "userCompanyAuth-userCompanyAuthPage",
        "userFinanceMsgLog-userFinanceMsgLog",
        "userFinanceMsgLog-userFinanceMsgLogPage",
        "userFindCarInfo-userFindCarInfo",
        "userFindCarInfo-userFindCarInfoPage",
        "userFindCarInfoSub-userFindCarInfoSub",
        "userFindCarInfoSub-userFindCarInfoSubPage",
        "userInfo-userInfo",
        "userInfo-userInfoPage",
        "userMsgInfo-userMsgInfo",
        "userMsgInfo-userMsgInfoPage",
        "userPersonalAuth-userPersonalAuth",
...
// 定义路由 - 组件
var templates = {};
var routes = [ {path: '/', redirect: 'userInfo/userInfoPage'}];
