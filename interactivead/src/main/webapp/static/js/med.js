...
var Config = {
    homeIndexTemplatesName: [
        ...
        "templateTodayReport-templateRealtimeReport",
        "templateTodayReport-templateRealtimeReportPage",
        "myindex-myindex",
        "advertiserInvoice-advertiserInvoice",
        "advertiserInvoice-advertiserInvoicePage",
    ],
    templateUrl: "template_med",
    templateFileSuffix: ".html?v=0309"
}
// 定义路由 - 组件
var templates = {};
var routes = [ {path: '/', redirect: 'mediaOwnerReport/mediaOwnerReportPage'}];
